...
from .routes import attention, rfid, auth, users, printer, settings, filaments, import_db, logs, camera, prints, import_zip, objects, import_spoolnymous
...
router.include_router(rfid.router,       prefix="/rfid",        tags=["rfid"])
